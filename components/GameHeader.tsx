...
const GameHeader: React.FC<GameHeaderProps> = ({ 
  ...
  return (
    <header className="h-14 border-b border-stone-900 flex items-center justify-between px-6 bg-stone-950 z-10 shrink-0">
      <div className="flex items-center gap-4">
        {/* If in game, show exit button (reset). If in Hub, just show Logo */}
        {!setupMode ? (
             <button onClick={onReset} className="text-stone-500 hover:text-red-500 transition-colors flex items-center gap-2" title="Sair para o Hub">
